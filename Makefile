...
ABSTRACT_VM_HEADERS := $(ABSTRACT_VM_HEADERS) $(HEADERS_DIR)/Compiler.hpp
...
ABSTRACT_VM_HEADERS := $(ABSTRACT_VM_HEADERS) $(HEADERS_DIR)/VirtualMahhine.hpp
...
ABSTRACT_VM_SOURCES := $(ABSTRACT_VM_SOURCES) $(SOURCES_DIR)/Compiler.cpp
